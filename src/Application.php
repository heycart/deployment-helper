...
namespace HeyCart\Deployment;

use Composer\InstalledVersions;
use HeyCart\Deployment\Helper\EnvironmentHelper;
use HeyCart\Deployment\Services\DotenvLoader;
...
class Application extends SymfonyApplication
{
    ...
    {
        parent::__construct('HeyCart Deployment Helper', InstalledVersions::getPrettyVersion('heycart/deployment-helper') ?? 'development');
        ...
        $this->getDefinition()->addOption(new InputOption('project-config', null, InputOption::VALUE_REQUIRED, 'Path to .heycart-project.yaml'));
    }
