...
class HeyCartStateTest extends TestCase
{
    ...
    private HeyCartState $state;

    protected function setUp(): void
    {
        $this->connection = $this->createMock(Connection::class);
        $this->state = new HeyCartState($this->connection);
    }

    public function testHeyCartIsNotInstalled(): void
    {
    ...
    public function testHeyCartIsInstalled(): void
    {
        $this->connection
            ->expects($this->once())
