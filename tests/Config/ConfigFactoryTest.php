...
use HeyCart\Deployment\Config\ConfigFactory;
...
class ConfigFactoryTest extends TestCase
{
    ...
    #[Env('HEYCART_STORE_LICENSE_DOMAIN', 'test')]
    ...
    public function testCreateWithProjectConfigOption(): void
    {
        ...
        $customConfigPath = __DIR__ . '/_fixtures/yml/.heycart-project.yml';
    ...
    public function testCreateWithProjectConfigOptionRelativePath(): void
    {
        ...
        $config = ConfigFactory::create(__DIR__ . '/_fixtures', $this->createMockApplication('yml/.heycart-project.yml'));

        static::assertTrue($config->extensionManagement->enabled);
        static::assertSame(['foo' => 'test'], $config->oneTimeTasks);
    }

    #[Env('HEYCART_PROJECT_CONFIG_FILE', '_fixtures/yml/.heycart-project.yml')]
